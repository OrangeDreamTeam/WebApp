...
queries.push('CREATE TABLE Service (UID int NOT NULL AUTO_INCREMENT, routeId int, clientId int, service varchar(255), notes varchar(10000), units int, FS varchar(255), startTime varchar(255), endTime varchar(255), signaturePath varchar(255), PRIMARY KEY (UID), providedServices varchar(1024));');
